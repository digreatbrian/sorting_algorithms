...
/**
 * print_left_right - Prints the left and right partitions
 * @array: array
...
/**
 * merge - Merges the values in the position of array
 * @array: first array
 * @size: size of second array
 * @cpy: copy of array
 * @first: initial position
...
/**
 * copy_array - Copies an int array
 * @arr: array src
 * @cpy: array dest
 * @size : array size
 */
...
/**
 * merge_sort - Creates partition and copy
 * @array: array
 * @size : array size
 */
